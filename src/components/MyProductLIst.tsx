...
const MyProductLIst: React.FC<MyProductLIstProps> = ({ userProducts }) => {
  ...
  return (
    <Table>
      <TableCaption>A list of all your products and their status</TableCaption>
      <TableHeader>
        <TableRow>
      ...
      <TableBody>
        {userProducts.map(product => (
          <TableRow key={product.id}>
            ...
            <TableCell className=''>{formatDate(product.createdAt)}</TableCell>
